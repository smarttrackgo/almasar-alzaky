...
export default function FloatingQuranBtn({ navigate }: { navigate: (p: Page) => void }) {
  return (
    <button
      ...
      title="القرآن الكريم"
      className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-gradient-to-br from-emerald-600 to-teal-600 text-white shadow-2xl hover:shadow-emerald-300/50 hover:scale-110 active:scale-95 transition-all duration-200 flex items-center justify-center group"
    >
